...
const SEEDED_SLUG = 'ep-gutenberg-youtube-channel-carousel';
const PRO_REQUIRED = true;

// Carousel layout, like grid, is gated by Pro's `is_allow_rander` filter.
...
test.describe('Gutenberg verify — YouTube Channel (carousel layout, Pro)', () => {
