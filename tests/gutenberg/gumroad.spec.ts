...
const SEEDED_SLUG  = 'ep-gutenberg-gumroad';
const URL_FRAGMENT = 'gumroad.com';

// Gumroad isn't recognised by EmbedPress in this build — the shortcode falls
// back to rendering the URL as plain text inside the embedpress figure.
test.describe('Gutenberg verify — Gumroad (URL fallback only)', () => {
