...
const SEEDED_SLUG = 'ep-gutenberg-anniemusic';

// Strict assertion: AnnieMusic integration must produce an iframe inside the
...
test.describe('Gutenberg verify — AnnieMusic', () => {
