...
const SEEDED_SLUG = 'ep-elementor-reverbnation-collection';

// Strict assertion: Reverbnation Collection integration must produce an iframe inside the
...
test.describe('Elementor verify — Reverbnation Collection', () => {
