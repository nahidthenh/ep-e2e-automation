...
const SEEDED_SLUG = 'ep-elementor-github-gist';

// Strict assertion: GitHub Gist integration must produce an iframe inside the
...
test.describe('Elementor verify — GitHub Gist', () => {
