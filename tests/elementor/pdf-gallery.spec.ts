...
const SEEDED_SLUG = 'ep-elementor-pdf-gallery';

test.describe(`Elementor verify — ${SOURCE_NAME} (grid)`, () => {
  test('seeded page renders grid layout with PDF canvas', async ({ page }) => {
    ...
    const gallery = page.locator('.ep-pdf-gallery[data-layout="grid"]').first();
