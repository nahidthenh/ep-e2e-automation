...
const SEEDED_SLUG = 'ep-elementor-beautifulai';

// Strict assertion: BeautifulAI integration must produce an iframe inside the
...
test.describe('Elementor verify — BeautifulAI', () => {
