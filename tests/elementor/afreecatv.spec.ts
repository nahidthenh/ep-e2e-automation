...
const SEEDED_SLUG = 'ep-elementor-afreecatv';

// Strict assertion: Afreecatv integration must produce an iframe inside the
...
test.describe('Elementor verify — Afreecatv', () => {
