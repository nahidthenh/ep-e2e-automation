...
const SEEDED_SLUG = 'ep-elementor-vidmount';
const IFRAME_SEL  = 'iframe[src*="vidmount.com/embed"]';
const URL_MARKER  = '1618d49e51edac';

// VidMount is JS-injected by its vendor script — the iframe appears in the
...
test.describe('Elementor verify — VidMount', () => {
